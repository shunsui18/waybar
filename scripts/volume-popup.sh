...
APP_EXEC="pwvucontrol"       # The command used to launch the app
MATCH_CLASS="com.saivert.pwvucontrol"   # The window class (get from 'hyprctl clients')
# Use the executable name for pgrep; if it's a python app, pgrep -f is safer
PROC_PATTERN="pwvucontrol"  
